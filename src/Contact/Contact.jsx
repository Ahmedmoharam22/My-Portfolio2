...
const Contact = ({ color }) => {
  ...
  return (
    <div
      id="contact"
      className={`text-center w-100 p-5 borderContact ${color[1]}`}
    >
      ...
      <div className="col-md-12 d-flex justify-content-center py-3">
        <form onSubmit={handleSubmit} className={`${color[2]} form-contact`}>
          ...
          <div className="sub">
            <button
              className={`btn2 btn-project btn-contact mt-3  ${
                color[3] === "bg-white4"
                  ? color[3] + " text-white"
                  : color[3] + " text-white"
              }`}
          ...
          {state.succeeded && (
            <p
              ...
              style={{ fontSize: "14px", marginTop: "1.7rem" }}
            >
              <Lottie
                loop={false}
                animationData={done}
      ...
      <p className="para-contact">
        Linkedin :
        <span title="Copy Link" onClick={copyText}>
          https://www.linkedin.com/in/ahmed-moharam-2b70a928b/
        </span>
      </p>
      <p className="para-contact">
        Mobile/WhatsApp/Telegram :
        <span title="Copy Number" onClick={copyText}>
          {" "}
          +201092635055
        </span>
      </p>
      <p className="para-contact">
        Email :
        <span title="Copy Gmail" onClick={copyText}>
          {" "}
